...
This document was generated with the [wearable device specification tool]("https://tscnlab.shinyapps.io/wearable_devices_spechelper/"), that enables a researcher to gather important requirements for a wearable device in a study, so that the device can be selected based on the requirements.

[**Restore this configuration in the tool through this link**](`r params$bookmark`)
